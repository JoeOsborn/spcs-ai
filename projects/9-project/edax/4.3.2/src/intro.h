 ...
 * http://abulmo.perso.neuf.fr/edax/4.3/edax.4-3-2.zip
 *
 ...
 * - version 4.3.1: Bug fixes. Cosmetic enhancement.
 * - version 4.3.2: Bug fix: Exact nodes count available during the search.
